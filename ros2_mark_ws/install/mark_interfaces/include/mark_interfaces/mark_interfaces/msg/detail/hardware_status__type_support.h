...
#ifndef MARK_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__TYPE_SUPPORT_H_
#define MARK_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__TYPE_SUPPORT_H_
...
#endif  // MARK_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__TYPE_SUPPORT_H_
