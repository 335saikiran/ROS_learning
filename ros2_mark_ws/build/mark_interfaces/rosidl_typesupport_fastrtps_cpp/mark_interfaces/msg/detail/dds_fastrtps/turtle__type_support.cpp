...
#include "mark_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mark_interfaces::msg::Turtle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mark_interfaces::msg::Turtle & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mark_interfaces::msg::Turtle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mark_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mark_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &mark_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mark_interfaces, msg, Turtle)() {
  return &mark_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
