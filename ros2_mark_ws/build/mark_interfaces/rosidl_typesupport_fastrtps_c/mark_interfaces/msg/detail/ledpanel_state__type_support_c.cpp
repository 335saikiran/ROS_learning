...
#include "mark_interfaces/msg/detail/ledpanel_state__rosidl_typesupport_fastrtps_c.h"
...
using _LedpanelState__ros_msg_type = mark_interfaces__msg__LedpanelState;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mark_interfaces__msg__LedpanelState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mark_interfaces__msg__LedpanelState * ros_message = static_cast<const mark_interfaces__msg__LedpanelState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mark_interfaces__msg__LedpanelState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mark_interfaces__msg__LedpanelState * ros_message = static_cast<mark_interfaces__msg__LedpanelState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mark_interfaces__msg__LedpanelState(cdr, ros_message);
}

static uint32_t _LedpanelState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mark_interfaces__msg__LedpanelState(
...
static size_t _LedpanelState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mark_interfaces__msg__LedpanelState(
