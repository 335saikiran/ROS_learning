...
class TurtleSpawnerNode(Node):
    def __init__(self):
        ...
        self.turtle_name_perfix_ = "turtle_"
        ...
        self.turtle_spawn_timer_ = self.create_timer(0.8, self.spawn_new_turtle)
    ...
    def spawn_new_turtle(self):
        self.turtle_name_counter_ += 1
        self.turtle_name = self.turtle_name_perfix_ + str(self.turtle_name_counter_)
        x = random.uniform(0.0, 11.0)
        y = random.uniform(0.0, 11.0)
        theta = random.uniform(0.0, 2*math.pi)
        self.call_spawn_service(x, y, theta, self.turtle_name)
